...
If you're using your own system, then ensure SSH is running on your system. [Check out the requirements](../../). You can use `qsys.create_sql_sample` to create the same sample data.
