...
* [Download the driver mirror from GitHub](https://github.com/codefori/docs/blob/main/src/assets/git/other/IBMiAccess_v1r1_WindowsAP_English.zip)
...
![](/src/assets/node_js/git_repo/a_setup_template.png)
...
![](/src/assets/node_js/git_repo/b_clone.png)
...
![](/src/assets/node_js/git_repo/b_clone_name.png)
...
![](/src/assets/node_js/setup/c_envsetup.png)
...
![](/src/assets/node_js/setup/d_npm.png)
...
![](/src/assets/node_js/miscellaneous/e_debug.png)
...
![](/src/assets/node_js/miscellaneous/e_result.png)
...
![](/src/assets/node_js/setup/f_enable.png)
...
![](/src/assets/node_js/miscellaneous/f_test.png)
...
![](/src/assets/node_js/miscellaneous/g_api.png)
...
![](/src/assets/node_js/routes/h_addroute.png)
...
![](/src/assets/node_js/routes/h_testroute.png)
...
![](/src/assets/node_js/routes/j_fixroute.png)

Now, when we test the route, we should see the correct response.

![](/src/assets/node_js/routes/j_testroute.png)
...
![](/src/assets/node_js/routes/k_createroute.png)
...
![](/src/assets/node_js/routes/k_rpgle.png)
...
![](/src/assets/node_js/routes/l_testroute.png)
...
![](/src/assets/node_js/miscellaneous/m_patchtest.png)
...
![](/src/assets/node_js/validator/n_addvalidator.png)
...
![](/src/assets/node_js/validator/n_testvalidator.png)
