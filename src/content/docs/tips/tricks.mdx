...
![assets/compare_01.png](/src/assets/code_for_i/features/miscellaneous/compare_01.png)
...
Install the [Db2 for IBM i extension](https://marketplace.visualstudio.com/items?itemName=HalcyonTechLtd.vscode-db2i)<Icon name="external" color="cyan" class="icon-inline" /> for this functionality. [Check out the documentation here](/src/content/docs/en/extensions/db2i/index.mdx).
...
![assets/db_03.png](/src/assets/db2_for_i/features/miscellaneous/db_03.png)
