...
A Profile allows the user to switch between settings quickly. You could use a profile to quickly change library list and other items specific to a project. A profile stores the following settings:
...
![Save Profile](/src/assets/code_for_i/features/environment_profiles/Connect_Profile_Save_01.png)
...
![Save Profile](/src/assets/code_for_i/features/environment_profiles/command_profile.png)
