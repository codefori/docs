...
You can create custom variable to use in your Actions' `Command to run` strings.    

<CardGrid>
  <Card>    
    ![variables](/src/assets/environment/variables_01.png)
  </Card>
  <Card>    
    ![variable in command](/src/assets/environment/variables_02.png)
  </Card>
</CardGrid>
...
You can create a profile using the `Custom Variables` node  `Declare custom variable` inline action.

![create](/src/assets/environment/variables_03.png)
...
![create](/src/assets/environment/variables_04.png)
...
<CardGrid>
  ...
  <Card>
    ![Variables options](/src/assets/environment/variables_05.png)
  </Card>  
</CardGrid>
