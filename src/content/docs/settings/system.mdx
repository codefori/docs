...
![](../../../assets/code_for_i/settings/settings_json.png)
...
Code snippets shared with every user of the system can be stored in the `/etc/vscode/snippets` folder. See [Shared Snippets](../../environment/snippets/).
