...
![assets/settings_01.png](/src/assets/code_for_i/settings/settings_01.png)
...
![](/src/assets/code_for_i/settings/safeDelete.png)
...
### Object Browser filter details

Controls where the definition of an object filter (libraries, objects, members, member text, dates, etc.) is shown in the OBJECT BROWSER:
...
Use `tooltip` to keep the browser compact when you have long filter definitions, and `description` if you'd rather not have a hover popping up over the tree.

See [Object Browser](../../browsers/object-browser/#filter-details-display) for the details of what is displayed.
...
![Panel on Right](/src/assets/code_for_i/features/output/LogOutput_01.png)

</Card></CardGrid>

You can clear the Output tab using the **Clear Output** icon on the right.

![Clear output](/src/assets/code_for_i/features/output/LogOutput_02.png)
