...
![assets/settings_01.png](../../../assets/code_for_i/settings/settings_01.png)
...
![](../../../assets/code_for_i/settings/safeDelete.png)
...
![Panel on Right](../../../assets/code_for_i/features/output/LogOutput_01.png)

</Card></CardGrid>

You can clear the Output tab using the **Clear Output** icon on the right.

![Clear output](../../../assets/code_for_i/features/output/LogOutput_02.png)
