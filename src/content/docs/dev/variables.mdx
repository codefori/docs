...
| -------------------- | ----------------------------------------- | ----------- | ------------------------------------------------------------- |
| Context value        | `code-for-ibmi:connected`                 | boolean     |                                                               |
...
| Environment variable | `DEBUG_CA_PATH`                           | string path |  |
| Environment variable | `DEBUG_MANAGED`                           | boolean     | Disabled all debug-setup related UI, for when managed outside of Code for IBM i |
