...
![](/src/assets/code_for_i/features/connection/connect_02.png)
...
<CardGrid>
<Card>
Enter the system details in the window that appears. You will need a password, a private key, or an SSH agent with the identities properly configured.
...
<Card>
![](/src/assets/code_for_i/features/connection/connect_03.png)
</Card>
</CardGrid>
...
<Card>
![](/src/assets/code_for_i/features/connection/connect_04.png)
</Card>
</CardGrid>
...
<Card>
![Connection editor](/src/assets/code_for_i/features/connection/connect_05.png)
</Card>
</CardGrid>
...
<Card>
![Disconnect icon](/src/assets/code_for_i/features/connection/connect_08.png)
</Card>
<Card>
Press <kbd>F1</kbd> and search for `IBM i: Disconnect`
</Card>
<Card>
![Search Disconnect](/src/assets/code_for_i/features/connection/connect_07.png)
</Card>
