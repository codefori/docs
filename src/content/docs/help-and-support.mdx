...
![](/src/assets/code_for_i/features/help_and_support/help_01.png)
...
![](/src/assets/code_for_i/features/help_and_support/help_03.png)

You can also search issues by adding text in the search bar:

![](/src/assets/code_for_i/features/help_and_support/help_04.png)
...
![](/src/assets/code_for_i/features/help_and_support/help_06.png)
...
4. Click the `Report an Issue` link and pick the extension on which to report the issue:
  ![](/src/assets/code_for_i/features/help_and_support/help_08.png)
...
6. Go to the `OUTPUT` tab and select `Code for IBM i`. Select the complete displayed contents and then copy and paste into the Github issue.:
   ![](/src/assets/code_for_i/features/help_and_support/help_05.png)
...
<Aside type="tip">
  ...
  ![](/src/assets/code_for_i/features/help_and_support/help_07.png)
</Aside>
...
![](/src/assets/code_for_i/features/help_and_support/help_02.png)
