...
[See GitHub issue here](https://github.com/codefori/vscode-ibmi/issues/1069)<Icon name="github" color="white" class="icon-inline" />.
...
There is a [known issue](https://github.com/codefori/vscode-ibmi/issues/1059)<Icon name="github" color="white" class="icon-inline" /> that when you start debugging from VS Code, the debugger hangs and doesn't launch.
