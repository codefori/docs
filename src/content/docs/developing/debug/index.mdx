...
* Debug Service Certificates setup
  * As of Code for iBM i 3.0.0, the Debug Service is configured inside of Navigator for IBM i. **If you're using Code for IBM i 3.0.0**, then you are required to use this method to configure and start the Debug Service. Code for IBM i 3.0.0 only support Debug Service 3+.
