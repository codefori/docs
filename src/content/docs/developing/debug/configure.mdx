...
<Aside type="note">You need to restart the ADMIN1 server after applying a Navigator PTF. 

The 3.0.2 Debug Service PTF must not be applied at IPL as a delayed PTF until the next fix comes out.
</Aside>
