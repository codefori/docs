...
![](/src/assets/debug/usage/debug3.png)
...
![](/src/assets/debug/usage/debug1.png)
...
![](/src/assets/debug/usage/debug2.png)
...
![Debug Service Entry Point](/src/assets/debug/usage/debugSEPView.png)
...
![](/src/assets/debug/errors/error_2.png)
...
- Find out the certificate location on the client machine
    ...
    * If the "capath" field is undefined, update your IBM i Debug extension to v3.0.3 and up; otherwise continue with the next step.
...
![](/src/assets/debug/errors/error_1.png)
...
**Answer**: Here are the supported Java versions for different OS levels in Debug Service v3.0.4:

    IBM i 7.6: Java 17
    IBM i 7.4/7.5: Java 11 and Java 17 (Default: Java 11)
    IBM i 7.3: Java 11

**Question**: How can I use Java 17 to start debug service on IBM i 7.4/7.5?  
**Answer**: You can switch to Java 17 by modifying a setting in host file /QIBM/ProdData/IBMiDebugService/bin/DebugService.env. You can change the following setting
