...
![](/src/assets/i_testing/Testing_LibraryValidation.png)
...
![](/src/assets/i_testing/Testing_TestExplorer.png)
...
<Aside type="note">
  ...
  ![](/src/assets/i_testing/Testing_GutterActions.png)
</Aside>
...
![](/src/assets/i_testing/Testing_CancellingTest.png)
...
![](/src/assets/i_testing/Testing_CancelledTestResult.png)
...
![](/src/assets/i_testing/Testing_TestResults.png)
...
![](/src/assets/i_testing/Testing_InlineAssertionError.png)
...
![](/src/assets/i_testing/Testing_TestCoverage.png)
...
![](/src/assets/i_testing/Testing_CodeCoverage.png)
...
2. Right-click on the test (or the gutter action) and select the **Execute Using Profile...** option.
  ![](/src/assets/i_testing/Testing_ExecuteUsingProfile.png)
3. Select the desired profile to be used.
  ![](/src/assets/i_testing/Testing_TestProfiles.png)

<Aside type="tip">
  You can change the default test profile if you prefer using the **Select Default Profile** option.
  ![](/src/assets/i_testing/Testing_DefaultProfiles.png)
</Aside>
...
![](/src/assets/i_testing/Testing_TestTags.png)
