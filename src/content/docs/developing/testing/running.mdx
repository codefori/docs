...
![](../../../../assets/i_testing/Testing_LibraryValidation.png)
...
![](../../../../assets/i_testing/Testing_TestExplorer.png)
...
<Aside type="note">
  ...
  ![](../../../../assets/i_testing/Testing_GutterActions.png)
</Aside>
...
![](../../../../assets/i_testing/Testing_CancellingTest.png)
...
![](../../../../assets/i_testing/Testing_CancelledTestResult.png)
...
![](../../../../assets/i_testing/Testing_TestResults.png)
...
![](../../../../assets/i_testing/Testing_InlineAssertionError.png)
...
![](../../../../assets/i_testing/Testing_TestCoverage.png)
...
![](../../../../assets/i_testing/Testing_CodeCoverage.png)
...
2. Right-click on the test (or the gutter action) and select the **Execute Using Profile...** option.
  ![](../../../../assets/i_testing/Testing_ExecuteUsingProfile.png)
3. Select the desired profile to be used.
  ![](../../../../assets/i_testing/Testing_TestProfiles.png)

<Aside type="tip">
  You can change the default test profile if you prefer using the **Select Default Profile** option.
  ![](../../../../assets/i_testing/Testing_DefaultProfiles.png)
</Aside>
...
![](../../../../assets/i_testing/Testing_TestTags.png)
