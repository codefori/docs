...
To open up source code, you can [create a filter in the Object Browser](/src/content/docs/en/browsers/object-browser.mdx) to browse source files.
...
Now you can edit the source using all the features of VS Code.
 ...
 ![Editing example](/src/assets/code_for_i/demo/EditComp-01.png)
...
![Editing max space](/src/assets/code_for_i/demo/EditComp-02.png)
...
![Compile successful](/src/assets/code_for_i/demo/EditComp-03.png)
...
![Complile failed](/src/assets/code_for_i/demo/EditComp-04.png)
...
![Squiggly errors](/src/assets/code_for_i/demo/EditComp-05.png)
...
![F8 next error](/src/assets/code_for_i/demo/EditComp-05A.png)
...
![Problems tab](/src/assets/code_for_i/demo/EditComp-06.png)
...
![Errors filter](/src/assets/code_for_i/demo/EditComp-07.png)
...
![Clear diagnostics](/src/assets/code_for_i/demo/EditComp-08.png)

### Compile Listing

The compile listing is always routed to a terminal, should you need to review it.

![Compile List in Terminal](/src/assets/code_for_i/features/actions/compile_list_01.png)
