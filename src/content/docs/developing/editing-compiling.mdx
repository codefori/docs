...
Now you can edit the source using all the features of VS Code.
 ...
 ![Editing example](../../../assets/code_for_i/demo/EditComp-01.png)
...
![Editing max space](../../../assets/code_for_i/demo/EditComp-02.png)
...
![Complile failed](../../../assets/code_for_i/demo/EditComp-04.png)
...
![Squiggly errors](../../../assets/code_for_i/demo/EditComp-05.png)
...
![F8 next error](../../../assets/code_for_i/demo/EditComp-05A.png)
...
![Problems tab](../../../assets/code_for_i/demo/EditComp-06.png)
...
![Errors filter](../../../assets/code_for_i/demo/EditComp-07.png)
...
![Clear diagnostics](../../../assets/code_for_i/demo/EditComp-08.png)

### Compile Listing

The compile listing is always routed to a terminal, should you need to review it.

![Compile List in Terminal](../../../assets/code_for_i/features/actions/compile_list_01.png)
