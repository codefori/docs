...
For source dates to be enabled, the QCCSID system value must not be 65535. See [our documentation about encoding](../../tips/ccsid/) and [IBM's documentation about the QCCSID system value](https://www.ibm.com/docs/i/7.5?topic=faqs-i-system-value-qccsid)<Icon name="external" color="cyan" class="icon-inline" />.
...
![Editing max space](/src/assets/code_for_i/features/source_dates/sourcedates_1.png)
...
![Editing max space](/src/assets/code_for_i/features/source_dates/sourcedates_2.png)
...
![Source sequence view](/src/assets/code_for_i/features/miscellaneous/srcseq_view.png)