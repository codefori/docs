...
Check out the IBM Project Explorer documentation on how to use [their migration process](https://ibm.github.io/vscode-ibmi-projectexplorer/#/pages/projectExplorer/migrate-source)<Icon name="github" color="white" class="icon-inline" />.
