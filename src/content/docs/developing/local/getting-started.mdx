...
* This step-by-step guide [in the rpg-git-book](https://worksofliam.github.io/rpg-git-book/7-tooling-vscode.html)<Icon name="github" color="white" class="icon-inline" />.
