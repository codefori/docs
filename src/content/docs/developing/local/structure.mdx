...
* or inside the [`iproj.json` file with the `includePath` property](https://ibm.github.io/vscode-ibmi-projectexplorer/#/pages/ibm-i-projects/iproj-json?id=includepath)<Icon name="github" color="white" class="icon-inline" /> to the paths where the compiler should look up (this is supported by ibmi-bob)

## Example project structure

Check out the [company_system](https://github.com/worksofliam/company_system)<Icon name="github" color="white" class="icon-inline" /> repository for a good example project which follows these rules.
