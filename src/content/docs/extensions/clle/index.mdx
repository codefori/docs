...
![Install CLLE](/src/assets/clle/Install_CL.png)
</Card>
...
![Example step 2](/src/assets/clle/ExCL_02.png)
...
![Example step 3](/src/assets/clle/ExCL_03.png)
...
![Example step 5](/src/assets/clle/ExCL_05.png)
...
![Command assist](/src/assets/clle/assist_01.png)
...
![Command assist all keywords](/src/assets/clle/assist_02.png)
...
![Command assist parameter](/src/assets/clle/assist_03.png)
...
![Command assist parameter](/src/assets/clle/assist_04.png)
...
![Outline view](/src/assets/clle/outlineView.png)
...
![Go to References](/src/assets/clle/goToReferences.png)

You can also use **Find All References** which will pop open the **References** view to show all references.

![Find All References](/src/assets/clle/findAllReferences.png)
...
![Peak Definition](/src/assets/clle/peakDefinition.png)
...
![Paramter Hover](/src/assets/clle/parameterHover.png)
...
![Full Documentation](/src/assets/clle/fullDocumentation.png)
...
![Syntax Checker](/src/assets/clle/syntaxChecker.png)
...
![Run CL example 1](/src/assets/clle/RunCL_01.png)

Press _Ctrl+R_ and success is reported:

![Run CL example 1](/src/assets/clle/RunCL_02.png)

Click _Open output_ if you want more detail or if the command fails: 

![Run CL example 1](/src/assets/clle/RunCL_03.png)
