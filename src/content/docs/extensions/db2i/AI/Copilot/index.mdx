...
![alt text](/src/assets/db2_for_i/features/AI/copilot_integration/references.png)
...
![alt text](/src/assets/db2_for_i/features/AI/copilot_integration/related.png)
...
![alt text](/src/assets/db2_for_i/features/AI/copilot_integration/followup.png)
...
To use the tool, you can either reference it by tagging `#result` in your request, or by using the _paperclip_ icon to attach _Run SQL statement_.

<CardGrid><Card>

![alt text](/src/assets/db2_for_i/features/AI/copilot_integration/toolA.png)

</Card><Card>

It will then take the result set of the statement and summarize the information based on your request.

![alt text](/src/assets/db2_for_i/features/AI/copilot_integration/toolB.png)
