...
## Introduction
![alt text](/src/assets/db2_for_i/features/AI/code_assitant/image-8.png)
...
<Aside type="tip">
  Check out [Use cases](/src/content/docs/en/extensions/db2i/AI/use-cases.mdx) for more tutorials and examples.
</Aside>
...
![alt text](/src/assets/db2_for_i/features/AI/code_assitant/image-21.png)
...
![alt text](/src/assets/db2_for_i/features/AI/code_assitant/image-19.png)
