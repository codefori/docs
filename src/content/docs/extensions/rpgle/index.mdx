...
![](/src/assets/rpgle/hw_1.png)
![](/src/assets/rpgle/hw_2.png)
...
![](/src/assets/rpgle/hw_3.png)

## What next?

Compiling the code from Visual Studio Code requires a different extension due to the fact that the compilers only exist on IBM i. Check out the official [documentation for Code for IBM i](/src/content/docs/en/) to get started.

### Content assist

Content assist provides code completion, hover information, and formatting issues to help the user write code correctly. 

![](/src/assets/rpgle/intellisense.png)
...
![](/src/assets/rpgle/fixedRuler.png)
...
![](/src/assets/rpgle/implementation.png)
...
![](/src/assets/rpgle/extract_procedure.png)
...
![](/src/assets/rpgle/lint_create.png)
...
![](/src/assets/rpgle/lint_options.png)
...
![](/src/assets/rpgle/lint_errors.png)