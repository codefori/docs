...
Below are some available lint configs. [See the `rpglint.json` schema for the most up to date rules](https://github.com/codefori/vscode-rpgle/blob/main/schemas/rpglint.json)<Icon name="github" color="white" class="icon-inline" />.
