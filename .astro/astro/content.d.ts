...
"environment/actions/execution.mdx": {
	id: "environment/actions/execution.mdx";
  slug: "environment/actions/execution";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"environment/actions/index.mdx": {
	id: "environment/actions/index.mdx";
